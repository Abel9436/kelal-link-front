    ...
    return (
        <div className="flex min-h-screen flex-col items-center justify-center bg-[#02140a] text-white selection:bg-emerald-500/30">
            ...
            <div className="relative z-10 text-center p-6 md:p-8">
                <h1 className="text-7xl md:text-9xl font-black text-emerald-900 mb-4 tracking-tighter opacity-50">ዐ</h1>
                <h2 className="text-2xl md:text-4xl font-black mb-4 tracking-tight">404 - ጠፍቷል</h2>
                <p className="text-emerald-100/40 max-w-[280px] sm:max-w-sm mx-auto mb-8 font-medium italic text-sm md:text-base">
                    The link you&apos;re looking for doesn&apos;t exist or has moved to another heritage site.
                </p>
                <a
                    href="/"
                    className="inline-flex items-center gap-2 bg-emerald-600 hover:bg-emerald-500 text-white px-6 md:px-8 py-3 md:py-4 rounded-2xl md:rounded-3xl transition-all font-black shadow-xl shadow-emerald-500/20 active:scale-95 text-sm md:text-base"
                >
                    Go back home
                </a>
            </div>
